      ...
      <div className="col-span-4 p-10">
        <div className="md:grid grid-cols-3">
          <div className="md:px-5 my-5 md:my-0">
            {/* card 1 */}
            <div className="bg-blue-100 px-4 py-8 flex items-center rounded text-5xl">
              <FaBook/>
              <div className="text-center ms-10 md:ms-5">
                <h3 className='text-lg'>Total No. of Books</h3>
          ...
          <div className="md:px-5 my-5 md:my-0">
            {/* card 2 */}
            <div className="bg-red-100 px-4 py-8 flex items-center rounded text-5xl">
              <FaUsers/>
              <div className="text-center ms-10 md:ms-5">
                <h3 className='text-lg'>Total No. of Users</h3>
                <h3 className="text-2xl">100+</h3>
              </div>
            </div>
          ...
          <div className="md:px-5 my-5 md:my-0">
            {/* card 3 */}
            <div className="bg-yellow-100 px-4 py-8 flex items-center rounded text-5xl">
              <FaPeopleGroup/>
              <div className="text-center ms-10 md:ms-5">
